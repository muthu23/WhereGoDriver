...
import com.wherego.driver.helpers.User;
...
/*
    public void getProfile(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(RequestList.Method.GET, URLHelper.USER_PROFILE_API+"?user_id="+strUserId,
            ...
            public void onResponse(JSONObject jsonProviderObj) {
                try {
                    ...
                    Picasso.get().load(URLHelper.BASE + jsonProviderObj.optString("picture")).memoryPolicy(MemoryPolicy.NO_CACHE).placeholder(R.drawable.ic_dummy_user).error(R.drawable.ic_dummy_user).into(profile_Image);
            ...
            @Override
            public HomeFragment<String, String> getHeaders() throws AuthFailureError {

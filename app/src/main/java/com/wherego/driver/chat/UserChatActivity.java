package com.wherego.driver.chat;
...
import com.wherego.driver.adapter.ChatAppMsgAdapter;
import com.wherego.driver.App;
import com.wherego.driver.R;
import com.wherego.driver.bean.ChatAppMsgDTO;
import com.wherego.driver.bean.ChatList;
...
import static com.wherego.driver.App.trimMessage;
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    SharedHelper.putKey(App.getContext(), "current_chat_provider_id", "" + jo.getString("provider_id"));
                                    SharedHelper.putKey(App.getContext(), "current_chat_user_id", "" + jo.getString("user_id"));
                                    SharedHelper.putKey(App.getContext(), "current_chat_request_id", "" + jo.getString("request_id"));
...
//        }
//
//        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(RequestList.Method.POST, URLHelper.login, object, new Response.Listener<JSONObject>() {
//            @Override
//            public void onResponse(JSONObject response) {
//
//                Log.v("SignUpResponse", response.toString());
//                SharedHelper.putKey(App.getContext(), "access_token", response.optString("access_token"));
//                SharedHelper.putKey(App.getContext(), "refresh_token", response.optString("refresh_token"));
//                SharedHelper.putKey(App.getContext(), "token_type", response.optString("token_type"));
//                getChatDetails();
//
//
//            }

...
public class User {
    ...
    private String mMultiplePaymentMethod;
    @SerializedName("otp")
    private String mOtp;
    ...
    private String mReferralUsed;
    @SerializedName("referrals")
    private String mReferrals;
    ...
    public String getMultiplePaymentMethod() {
        return mMultiplePaymentMethod;
    }

    public void setMultiplePaymentMethod(String multiplePaymentMethod) {
        mMultiplePaymentMethod = multiplePaymentMethod;
    }
